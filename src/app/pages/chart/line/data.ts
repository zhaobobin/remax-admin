import { ChartOptions } from './line.model';
 ...
 * Basic Line Chart
 */
const basicLineChart: ChartOptions = {
  series: [{
    name: "Desktops",
 ...
 * Zoomable Timeseries
 */
const zoomableTimeseriesChart: ChartOptions = {
  series: [{
    name: 'XYZ MOTORS',
    data: [{
 ...
 */
const lineWithDataLabelsChart: ChartOptions = {
  chart: {
    height: 380,
    type: 'line',
    zoom: {
 ...
 * Dashed Line
 */
const dashedLineChart: ChartOptions = {
  chart: {
    height: 380,
    type: 'line',
    zoom: {
 ...
 */
const lineAnnotationsChart: ChartOptions = {
  series: [{
 ...
 * Syncing Line Charts
 */
const SyncingLineChart: ChartOptions = {
  series: [{
 ...
 * Syncing Area Charts
 */
const SyncingAreaChart: ChartOptions = {
  series: [{
    data: generateDayWiseTimeSeries(new Date('11 Feb 2017').getTime(), 20, {
      min: 10,
      max: 60
 ...
 * Brush Line Charts
 */
const brushLineChart: ChartOptions = {
  series: [
    {
      name: "series1",
 ...
 * Brush Area Charts
 */
const brushAreaChart: ChartOptions = {
  series: [
    {
      name: "series1",
      data: generateDayWiseTimeSeries(new Date('11 Feb 2017').getTime(), 185, {
 ...
 * Stepline Charts
 */
const stepLineChart: ChartOptions = {
  series: [{
 ...
 * Gradient Charts
 */
const gradientChart: ChartOptions = {
  series: [{
    name: 'Likes',
 ...
 */
const missingDataChart: ChartOptions = {
  series: [{
    name: 'Peter',
